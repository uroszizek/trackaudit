...
const T = {
  en: {
    ...
    checklistDetails: {
      consentOk: "Correctly implemented — all parameters set to denied by default.",
      consentWarn: "Consent Mode v2 found but not all parameters are set to denied. Check ad_user_data and ad_personalization.",
      consentFail: "Missing or incomplete consent mode implementation. All 6 parameters should default to denied for EU visitors.",
      serverOk: "Server-side GTM detected. Data is routed through your own server, improving accuracy and bypassing ad blockers.",
      ...
      pixelOk: "No tracking cookies set before user consent.",
